...
ADD_USER="alias mcloud-adduser='$LOCATION_OF_SCRIPT addUser'"
REMOVE_USER="alias mcloud-removeuser='$LOCATION_OF_SCRIPT removeUser'"
MCLOUD_ITSELF="alias mcloud='$LOCATION_OF_SCRIPT'"

CONFIG_FILE_NAME="$HOME/MCLOUD_CONFIG_SERVER"
...
installMCLOUD() {
	...
	then
		...
		sudo $CURRENT_RUN/openvpn-install.sh
